...
let course = [
	...
	['Объектно-ориентированные технологии разработки ПО', 'ООТРПО'],
	['Философия', 'Фил.'],
	['Основы теории машинного обучения', 'ОТМО'],
	['Современные технологии баз данных', 'СТБД'],
	['Методы активной идентификации динамических систем', 'МАИДС'],
	['Модели временных рядов', 'МВР'],
];
